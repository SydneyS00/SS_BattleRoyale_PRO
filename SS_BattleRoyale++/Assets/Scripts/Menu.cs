...
public class Menu : MonoBehaviourPunCallbacks, ILobbyCallbacks
{
    ...
    void Start()
    {
        ...
        //enable the cursour since we hide it when the player is in the game
    ...
    {
        //disable all of the other screens
        mainScreen.SetActive(false);
        createRoomScreen.SetActive(false);
        lobbyScreen.SetActive(false);
        lobbyBrowserScreen.SetActive(false);

        //activate the requested screens
    ...
    void UpdateLobbyUI()
    {
        //enable or disable the start game button if host
    ...
    public void UpdateLobbyBrowserUI()
    {
        ...
        {
            //get or create the bitton object
